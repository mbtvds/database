...
-- Exercise 2.1: Simple B-tree index
...
-- Exercise 2.3: View all index information
SELECT
    tablename,
    indexname,
    indexdef
...
-- Exercise 4.2: UNIQUE constraint creates index
...
-- Exercise 5.2: Index NULLS FIRST
...
-- Exercise 7.1: Rename index
ALTER INDEX emp_salary_idx RENAME TO employees_salary_index;

SELECT indexname FROM pg_indexes WHERE tablename = 'employees';

-- Exercise 7.2: Drop index
...
-- Exercise 10.1: List all indexes with sizes
SELECT
    schemaname,
    tablename,
    indexname,
...
-- Exercise 10.3: Document indexes
